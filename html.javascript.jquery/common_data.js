...
//--------------------------------------------------------------------
var weekMsg = {
	"월요일":"월요일은 9시에 회의가 있는 날 입니다. 보고서 준비해 주십시오."
	, "화요일":"화요일은 대청소 날입니다."
	, "수요일":"수요일은 봉사활동 날입니다."
	, "목요일":"목요일은 부서별 회식 날입니다."
...
//--------------------------------------------------------------------
var scheduleMsg = [
	["2021-07-20","2021-07-20일은 고온주의보 상태입니다."]
	,["2021-07-23","2021-07-23일은 휴강일 입니다."]
	,["2021-08-13","2021-08-13일은 휴강일 입니다."]	
	,["2021-08-16","2021-08-16일은 휴강일 입니다."]	
	,["2021-11-03","2021-11-03일은 창립 기념일 입니다."]	
]
...
/*
자스에서 JSON은 자바의 HashMap객체와 흡사하다<참고>
HashMap_map = new HashMap();
Map.put( "s_no", "1" );
Map.put( "s_name", "오세황" );
